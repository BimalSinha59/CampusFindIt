            ...
            <div className="w-full max-w-md overflow-hidden border shadow-xl card bg-base-100 border-base-300">
                <div className="p-8 card-body">
                    ...
                    <div className="mb-6 text-center">
                        ...
                        <p className="mt-2 font-medium text-base-content/60">Join your campus community</p>
                    </div>

                    {/* Error Alert */}
                    {error && (
                        <div className="py-3 mb-6 duration-300 border-none shadow-sm alert alert-error rounded-2xl bg-error/10 text-error animate-in fade-in slide-in-from-top-2">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="form-control">
                            <label className="label">
                                <span className="font-bold label-text text-base-content/70">Full Name</span>
                            </label>
                            <div className="relative group">
                                <User className="absolute transition-colors -translate-y-1/2 left-4 top-1/2 text-base-content/30 group-focus-within:text-primary" size={18} />
                                <input
                                    type="text"
                                    required
                    ...
                    <div className="justify-center mt-8 card-actions">
                        <p className="text-sm font-medium text-center text-base-content/60">
                            ...
                            <Link to="/login" className="font-bold link link-primary link-hover">
                                Log in instead
                            </Link>
                        </p>
                    </div>
